...
public class Node {
	...
	//ID's of communities this node is a member of. Only needed for faster output writing.
	private Set<Integer> communities = new HashSet<Integer>();
	/**
	...
	public boolean equals(Object obj) {
		...
		if (obj != null && getClass() == obj.getClass()) {
	        ...
	        if(this.getNodeId()==other.getNodeId() ){
	            ...
	            if(this.getNeighbhours()==null && other.getNeighbhours()==null){
	            	res=true;
	            }
	        	if(this.getNeighbhours()!=null && this.getNeighbhours().equals(other.getNeighbhours())){
	        		res=true;
	        	}
	        }
	    }
